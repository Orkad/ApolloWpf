...
namespace ApolloWpf.Business
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        private SimplePrincipal GetApolloPrincipal()
        {
            ...
            if (principal == null)
                throw new SecurityException("The application's default thread principal must be set to a ApolloPrincipal");
            return principal;
        }
        ...
        public bool IsLoggedIn() => GetApolloPrincipal().Identity.IsAuthenticated;
